...
/// - Import/Export midi files into project
...
public:
	...
	const std::string& GetCurrentProjectPath() const { return mCurrentProjectPath; }
	...
	void SetDirtyStateCallback(DirtyStateCallback callback) { mDirtyStateCallback = callback; }
	...
	void SetClearUndoHistoryCallback(ClearUndoHistoryCallback callback) { mClearUndoHistoryCallback = callback; }
